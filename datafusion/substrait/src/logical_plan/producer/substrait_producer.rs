...
use crate::logical_plan::producer::{
    ...
    from_set_comparison, from_sort, from_subquery_alias, from_table_scan, from_try_cast,
    from_unary_expr, from_union, from_values, from_window, from_window_function,
    to_substrait_rel, to_substrait_rex, to_substrait_type,
};
...
pub trait SubstraitProducer: Send + Sync + Sized {
    ...
    fn handle_placeholder(
        ...
        not_impl_err!("Cannot convert {placeholder:?} to Substrait")
    }
